              ...
              <div className={`rounded-2xl border border-white/10 bg-white/5 p-4 space-y-4 ${controlsDisabled ? "opacity-60" : ""}`}>
                ...
                <div className="space-y-2">
                  ...
                  <input type="range" min="0" max="1200" step="60" value={detectionIntervalMs}
                    ...
                    disabled={controlsDisabled} className="w-full accent-sky-400 disabled:opacity-50 disabled:cursor-not-allowed" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input type="range" min="0" max="1" step="0.01" value={triggerMinScore}
                    ...
                    disabled={controlsDisabled} className="w-full accent-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed" />
                </div>
              </div>

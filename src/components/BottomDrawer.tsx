...
interface BottomDrawerProps {
  ...
  /** Tall scrollable drawer (gallery) vs compact (pickers) */
  fullHeight?: boolean;
  /** Auto-close with animation when any button inside is clicked */
 ...
 */
export function BottomDrawer({ title, onClose, children, fullHeight = false, closeOnSelect = false }: BottomDrawerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end" onClick={handleClose}>
      ...
      >
        {/* Tap to close — the handle visually suggests dismissal */}

export function CameraSwitchIcon({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        ...
        d="M4.5 9.1A2.6 2.6 0 017.1 6.5h2.05l.72-1.05c.3-.44.81-.7 1.35-.7h2.56c.54 0 1.05.26 1.35.7l.72 1.05h2.05A2.6 2.6 0 0119.5 9.1v7.3a2.6 2.6 0 01-2.6 2.6H7.1a2.6 2.6 0 01-2.6-2.6V9.1z"
      />
      <circle cx="12" cy="12.4" r="2.3" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.8 7.6c1.4.3 2.65 1.35 3.1 2.8" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.9 9.6l.95 1.55 1.35-.95" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.2 16.9c-1.4-.3-2.65-1.35-3.1-2.8" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.1 14.9l-.95-1.55-1.35.95" />
    </svg>
  )
}
...
export function CameraEmptyIcon({ className }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function StripIcon({ className }) {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6 3h12a1.5 1.5 0 011.5 1.5v15a1.5 1.5 0 01-1.5 1.5H6a1.5 1.5 0 01-1.5-1.5v-15A1.5 1.5 0 016 3z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M7.5 5.25h9v3.5h-9zM7.5 10.25h9v3.5h-9zM7.5 15.25h9v3.5h-9z"
      />
    </svg>
  )
}
...
export function RemoteIcon({ className }) {
  return (
    <svg
      className={className}
      fill="none"
